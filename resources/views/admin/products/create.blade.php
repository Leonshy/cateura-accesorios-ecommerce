    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white border border-stone-100 shadow-sm p-6 space-y-4">
                ...
                <x-admin.media-picker name="image" value="{{ old('image') }}" label="Imagen principal" hint="1200×1500 px recomendado" aspect="4/5" />
                <x-admin.media-picker-multi name="gallery_images" :values="old('gallery_images', [])" label="Galería (múltiple)" hint="1200×1500 px recomendado, igual que la imagen principal" aspect="4/5" />
            </div>
