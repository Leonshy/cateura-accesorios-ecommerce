            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-stone-500 text-sm">{!! nl2br(e($contactAddress)) !!}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="{{ paraguay_tel_href($contactPhone) }}" class="text-copper-500 hover:text-copper-600 transition-colors">{{ $contactPhone }}</a>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:{{ $contactEmail }}" class="text-copper-500 hover:text-copper-600 transition-colors">{{ $contactEmail }}</a>
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="{{ $instagramUrl }}" target="_blank" rel="noopener" class="text-copper-500 hover:text-copper-600 transition-colors">Instagram</a>
                    </div>
                </div>
                @endif
            </div>
